  ...
  return (
    <section id="journey" className="py-12 ">
      <div className="flex flex-col items-center mb-16 text-center">
        <h2 className="text-[#2f3e46] text-3xl font-bold tracking-tight mb-2">
          My Journey
        </h2>
      ...
      <div className="relative">
        <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 top-0 bottom-0 w-[2px] bg-[#2F3E46]/10 "></div>
          ...
          {timeline.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute left-4 md:left-1/2 transform -translate-x-1/2 w-4 h-4 bg-[#84a98c] rounded-full border-4 border-[#F5F5F0]  z-10"></div>
                <div
                  className={`w-full md:w-1/2 pl-12 md:pl-0 ${isLeft ? "md:pr-16 md:text-right" : "md:pl-16 md:text-left"}`}
                >
                  <div className="bg-white border border-[#2F3E46]/5 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
                    <span className="text-[#84a98c] text-xs font-bold uppercase tracking-widest mb-2 block">
                      {item.year}
                    </span>
                    <h3 className="font-bold text-[#2f3e46] text-lg">
                      {item.title}
                    </h3>
                    <p className="text-sm font-medium text-[#2f3e46]/50 mb-4">
                      {item.location}
                    </p>
