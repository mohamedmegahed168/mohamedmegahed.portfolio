...
export default function WhatIDo() {
  ...
  return (
    <section id="whatIDo" className="py-12 px-8 mb-20 bg-[#fcfaf7]">
      <motion.div
      ...
      >
        <div className="h-[1px] flex-grow bg-[#2F3E46]/10 "></div>
        <h2 className="text-[#2f3e46] text-2xl font-bold tracking-tight">
          What I Do
        </h2>
        <div className="h-[1px] flex-grow bg-[#2F3E46]/10"></div>
      </motion.div>
        ...
        {services.map((service, index) => {
          ...
          return (
            <motion.div
              key={index}
              variants={fadeInUp}
              className="group flex flex-col gap-5 rounded-2xl border border-[#2F3E46]/5  bg-white p-8 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:border-[#84a98c]/30"
            >
              ...
              <div className="flex flex-col gap-3">
                <h3 className="text-[#2f3e46] text-xl font-bold">
                  {service.title}
                </h3>
                <p className="text-[#2f3e46]/60  text-sm leading-relaxed">
                  {service.description}
                </p>
              </div>
            </motion.div>
